...
import { DashboardBLoC } from './index.bloc';
import ioc from '../../../ioc';
ChartJS.register(
  CategoryScale,
  LinearScale,
...
const ProductCard = memo((obj: Product) => {
  return (
    <div
...
const Dashboard = memo<PropsWithChildren<Object>>((props) => {
  const bloc = ioc.useBLoC(DashboardBLoC, props);
    ...
    <div className={`d-flex flex-column`}>
      <div className={`d-flex align-items-start`}>
        ...
        <div className={`flex-fill ${styles.borderleft} p-5 mh-90`}>
          <section
            className={`w-40 d-flex align-items-center justify-content-between`}
          >
            <Image src={profile} alt="Profile" />
            <div className={`w-80 d-flex flex-column`}>
              <span className={`fw-700 text-11`}>
                Acme distributions, Ikeja lagos
              </span>
              <span className={`fw-400 text-09 color-gray-500`}>
          ...
          <section
            className={`d-flex align-items-center px-5 py-4 justify-content-between mt-5 border rounded`}
          >
            <div className={`d-flex flex-column`}>
              <span className={`fw-600 color-black`}>Available for payout</span>
              <div className={`d-flex align-items-center`}>
                <span className={`fw-600 text-22 color-black me-3`}>
                  ₦14.2M
                </span>
                <OverlayTrigger
                  key="bottom"
                  ...
                  overlay={
                    <Tooltip id={`tooltip-bottom`}>
                      <div className={`d-flex flex-column`}>
                        ...
                        <span className={`fw-500 color-white text-11`}>
                          ₦14,243,473.88
                        </span>
                      </div>
                    </Tooltip>
              ...
              <Link href="">
                <a className={`fw-700 link hover color-safety-blue`}>
                  Go to Payments
                </a>
              </Link>
            </div>
            ...
            <div className={`d-flex flex-column`}>
              ...
              <span className={`fw-500 color-gray-500`}>
                47 completed orders since 9:12 AM{' '}
              </span>
            </div>
          ...
          <section className={`mt-5 d-flex align-items-center`}>
            <aside className={`border rounded w-70`}>
              <div className={`d-flex align-items-center border-bottom px-3`}>
                ...
                <span
                  onClick={() => setSelectedTab('productSales')}
                  className={`link p-3 ${
                    selectedTab === 'productSales'
                      ? 'color-primary fw-800 border-bottom border-3 border-primary'
                      : 'color-gray-500'
                  }`}
                >
                ...
                <span
                  onClick={() => setSelectedTab('orderVolume')}
                  className={`link p-3 ${
                    selectedTab === 'orderVolume'
                      ? 'color-primary fw-800 border-bottom border-3 border-primary'
                      : 'color-gray-500'
                  }`}
                >
                ...
                <div
                  className={`bg-gray-100 ${styles.rounded} px-3 py-2 link hover`}
                >
              ...
              <div
                id="earnings"
                className={`${styles.tabbox} d-flex flex-column ${
                  selectedTab === 'earnings' ? 'd-block' : 'd-none'
                } p-3`}
              >
                <span className={`text-12 fw-700`}>₦4,542,768.89</span>
                <span className={`color-gray-500 text-09`}>
                  Earnings includes product sale and delivery fees
                </span>
              ...
              <div
                ...
                className={`${styles.tabbox} ${
                  selectedTab === 'productSales' ? 'd-block' : 'd-none'
                } p-3`}
              >
              ...
              <div
                id="ordervolume"
                className={`${styles.tabbox} ${
                  selectedTab === 'orderVolume' ? 'd-block' : 'd-none'
                } p-3`}
              >
            ...
            <aside
              className={`bg-safety-blue ${styles.tabboxfullheight} d-flex flex-column justify-content-center align-items-center border rounded w-30`}
            >
              ...
              <div className={`d-flex align-items-center`}>
                <span className={`fw-400 text-09 color-white`}>
              ...
              <div
                className={`${styles.button} text-center fw-700 px-5 py-2 link hover mt-4`}
              >
                View Order Details
              </div>
            </aside>
          ...
          <section className={`mt-5 d-flex align-items-center`}>
            <aside className={`border rounded w-50`}>
              <div className={`d-flex align-items-center border-bottom p-3`}>
                <div className={`d-flex flex-column`}>
                  ...
                  <span className={`text-09 color-gray-500`}>
                    Products are ranked by order volume
                  </span>
                </div>
                <div
                  className={`bg-gray-100 ${styles.rounded} px-3 py-2 link hover`}
              ...
              <div className={`${styles.tabbox2} d-flex flex-column p-3`}>
                ...
                <Link href="">
                  <a
                    className={`mt-3 color-safety-blue fw-700 text-center text-decoration-underline`}
                  >
                    View all products
                  </a>
                </Link>
            ...
            <div className="px-4">&nbsp;</div>
            <aside
              className={`${styles.tabboxfullheight2} d-flex flex-column justify-content-between align-items-center  rounded w-50`}
            >
              <div
                className={`d-flex align-items-center justify-content-between border w-100 p-3`}
              >
                ...
                <Link href="">
                  <a className="d-flex fw-700 color-safety-blue text-decoration-underline">
                    Process Order
                  </a>
                </Link>
              </div>
