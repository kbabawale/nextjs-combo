        ...
        <div className={`d-flex flex-column`}>
            ...
            <main className={`mt-5 d-flex flex-column flex-fill justify-content-center align-items-center text-left`}>
                ...
                <form className={`d-flex flex-column w-30 mx-auto`}>
                    ...
                    <div className="my-2">
                        <span className={`fw-400 text-11`}>{`Enter the 4-digit PIN sent to ${phoneNumber} to authorize login or `}</span>
                        <Link href="/" className={`fw-400 text-11 link hover`}><a>resend PIN</a></Link>
                    </div>
