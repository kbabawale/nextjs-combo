...
import { Data, HeadCell, PaymentType } from "../../../model/dataTable";
...
const rows = [
    createData(10000, 'Jenny Drink Stores', '', new Date('2022-05-01'), 230394, PaymentType.CARD_PAYMENT),
    createData(10000, 'Kenny Drink Stores', '', new Date('2022-05-03'), 230394, PaymentType.CASH_PAYMENT),
    createData(10000, 'Tenny Drink Stores', '', new Date('2020-05-01'), 230394, PaymentType.CARD_PAYMENT),
    createData(10000, 'Benny Drink Stores', '', new Date('2021-05-01'), 230394, PaymentType.CASH_PAYMENT),
    createData(10000, 'Denny Drink Stores', '', new Date('2022-01-31'), 230394, PaymentType.CARD_PAYMENT),
    createData(10000, 'Yenny Drink Stores', '', new Date('2022-05-01'), 230394, PaymentType.CARD_PAYMENT),
    createData(10000, 'Renny Drink Stores', '', new Date('2020-12-25'), 230394, PaymentType.CASH_PAYMENT),
    createData(10000, 'Henny Drink Stores', '', new Date('2020-11-01'), 230394, PaymentType.CARD_PAYMENT)
];
...
export default function NewOrderDataTable() {
    const [order, setOrder] = useState<Order>('asc');
    const [orderBy, setOrderBy] = useState<keyof Data>('customerName');
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                                ...
                                                <div className={`d-flex align-items-center`}>
                                                    ...
                                                    <div className={`ms-2 d-flex flex-column`}>
                                                        ...
                                                        <div className={`d-flex align-items-center`}>
                                                            ...
                                                            {index % 2 ? <div className={`bg-error px-2 py-1 rounded ms-2`}>
                                            ...
                                            <TableCell align="right"><span onClick={toggleModal} className={`link hover color-safety-blue text-decoration-underline fw-700`}>Process Order</span></TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
