...
type AppProps = {
  ...
  processForm?: <T>(type: ModalType, data: T) => void;
};
...
const VehicleRegComponent = ({ title }: VehicleRegProps) => {
  return (
    <div className={`my-4 d-flex align-items-center justify-content-between`}>
      ...
      <div
        className={`w-30 d-flex flex-column align-items-center rounded p-3 ${styles.dashedBorder}`}
      >
        <span className={`color-gray-400 text-09`}>
          Drag &amp; Drop to upload
        </span>
...
const VehicleDocumentComponent = ({
  title,
  filesize,
  expired = false,
}: VehicleDocumentProps) => {
  return (
    <div className={`d-flex flex-column me-3 mb-1 w-40`}>
      <div
        className={`border border-secondary rounded p-2 d-flex justify-content-between align-items-center`}
      >
      ...
      <span className={`${expired ? 'error fw-800 text-09' : 'color-white'}`}>
        {expired ? 'Expired' : 'Not'}
      </span>
    </div>
  );
...
const Modal = memo<AppProps>((props) => {
  const {
    modalIsOpen,
    type,
    hideModal,
  ...
  const {
    ...
    formState: { errors: errorsChangePasswordForm },
  } = useForm<ChangePasswordForm>();

  const {
    register: registerChangeNameForm,
    handleSubmit: handleSubmitChangeNameForm,
    reset: resetChangeNameForm,
    formState: { errors: errorsChangeNameForm },
  } = useForm<ChangeNameForm>();

  const {
    register: registerChangeEmailForm,
    handleSubmit: handleSubmitChangeEmailForm,
    reset: resetChangeEmailForm,
    formState: { errors: errorsChangeEmailForm },
  } = useForm<ChangeEmailForm>();

  const onSubmitChangePasswordForm = (data: ChangePasswordForm) => {
    if (
      data.newPassword.toString().trim() !=
      data.confirmNewPassword.toString().trim()
    ) {
      UtilFunction.notification('New Passwords Do Not Match', 'failure');
    } else {
      processForm?.(ModalType.SETTINGSCHANGEPASSWORD, data);
  ...
  const onSubmitChangeNameForm = (data: ChangeNameForm) => {
    if (
      ...
      processForm?.(ModalType.SETTINGSCHANGENAME, data);
      // resetChangeNameForm({
      //   fullname: '',
      // });
    }
  ...
  const onSubmitChangeEmailForm = (data: ChangeEmailForm) => {
    processForm?.(ModalType.SETTINGSCHANGEEMAIL, data);
  };
  ...
  return (
    ...
    >
      {type === ModalType.UPLOADPRODUCT && (
        <div
          className={`d-flex flex-column align-items-center px-3 ${styles.overflow}`}
        >
          <span className={`fw-700 text-11`}>Upload Document</span>
          <div className="mt-5">
            <span>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis
              metus vel diam commodo consequat. Nulla eleifend sem quam, nec
              porta elit pulvinar et.{' '}
              <Link href="">
                <a className="color-safety-blue">download a sample document</a>
              </Link>
            </span>
          </div>
          <div
            className={`${styles.UploadProductbox} link hover py-5 w-100 my-3 d-flex flex-column align-items-center`}
          >
            <span className={`color-gray-400 text-11`}>Drop to upload</span>
            <span className={`color-gray-400 text-11`}>or</span>
            <span
              className={`text-decoration-underline color-safety-blue fw-700 text-11`}
            >
              Browse file
            </span>
          </div>
        ...
        <div className={`d-flex flex-column px-3 ${styles.overflow}`}>
          ...
          <div className={`mt-5 d-flex flex-column`}>
            ...
            <div className={`mt-2 d-flex  align-items-center`}>
              <input type="checkbox" />
              <span className={`ms-3 fw-400 text-11`}>
                Enable promotions to give customers special deals on your
                product{' '}
              </span>
            </div>
            <div
          ...
          <div
            className={`${styles.UpdateProductdangerBG} mb-5 p-2 mt-5 d-flex  align-items-center`}
          >
            <input type="checkbox" />
            <div className="ms-3">
              <span className="fw-800">Unpublish:</span>
              <span className="ms-2">
                Mark Product as out of stock to send to unpublished list{' '}
              </span>
            </div>
          </div>
        </div>
      ...
      {type === ModalType.ORDERDETAILS && (
        <div className={`d-flex flex-column align-items-center`}>
          <div
            className={`w-100 px-3 pb-3 d-flex align-items-center justify-content-between border-bottom border-secondary`}
          >
            ...
            <span
              className={`align-self-start link hover`}
              onClick={() => {
                hideModal?.();
              }}
            >
          ...
          <div
            className={`px-3 d-flex align-items-center justify-content-between mt-4 w-100`}
          >
            <div className={`d-flex align-items-center`}>
              <div
                style={{
              ...
              <div className={`ms-2 d-flex flex-column`}>
                ...
                <div className={`d-flex align-items-center`}>
                  ...
                  <div className={`bg-error px-2 py-1 rounded ms-2`}>
                    ...
                    />
                    <span className={`ms-1 color-white text-09 fw-600`}>
                      Urgent
                    </span>
                  </div>
                </div>
          ...
          <div className={`px-3 w-100 mt-3`}>
            <Alert
              ...
              label=" StoreDash recommends orders are processed within 30mins."
          ...
          <div className={`px-3 d-flex flex-column w-100 mt-4`}>
            ...
            <div className={`d-flex my-3 align-items-center`}>
              <div className={`w-70 d-flex flex-column`}>
                <span className={`color-gray-600 text-09`}>
                  Drop-off location
                </span>
                <span className={`text-11`}>
                  A.G Leventis building Iddo House, Herbert Macaulay Way, Lagos
                  Mainland 101245, Lagos
                </span>
              </div>
            </div>
          </div>
          ...
          <div className={`px-3 d-flex flex-column w-100 mt-4`}>
            ...
            {Array.from(Array(5).keys()).map((x, index) => (
              <div key={index} className={`mb-5 d-flex align-items-center`}>
                ...
                <div
                  className={`rounded bg-lime-yellow`}
                  style={{ width: '60px', height: '60px' }}
                ></div>
                <div className={`ms-3 d-flex flex-column`}>
                  <span className={`fw-500 text-11`}>
                    Coca-cola Coke Can Drink (X24 pack)
                  </span>
      ...
      {type === ModalType.CONFIRMPICKUP && (
        ...
        >
          ...
          <div className="mt-5">
            <span>
              Please confirm that the ordered items have been packaged and
              labelled properly and is ready for pick up when the driver
              arrives. Be sure to authenticate the pickup with the 4-digit PIN.
            </span>
          </div>
          <div className={`mt-5 w-100 d-flex justify-content-between`}>
            <Button
      ...
      {type === ModalType.UPDATEBILLING && (
        <div
          className={`d-flex flex-column align-items-center px-3 ${styles.overflow}`}
        >
          <span className={`align-self-start fw-800 text-17`}>
            Update Billing info
          </span>
          <span className={`align-self-start mt-1 color-gray-700`}>
            You can update you banking information and invoice email
          </span>
          ...
          <div className={`w-100 mt-5 d-flex flex-column`}>
            ...
            <ControlInput
              type="email"
              placeholder="joshAkanji@company.com"
              wide={true}
            />
          </div>
          <span className={`align-self-start color-gray-600`}>
            Invoices are sent to this email 3 days to the due billing date
          </span>
      ...
      {type === ModalType.ADDVEHICLE && (
        <div className={`d-flex flex-column px-3 ${styles.overflow}`}>
          ...
          <div className={`mt-5 d-flex flex-column`}>
            ...
            <ControlTextArea
              placeholder="Some description about the the vehicle e.g dents, custom colour (optional)"
              wide={true}
            />
          </div>
          <div className={`mt-5 d-flex flex-column`}>
          ...
          <div
            className={`${styles.AddVehicleinfoBG} mb-5 p-2 mt-5 d-flex  align-items-center`}
          >
            <input type="checkbox" />
            <div className="ms-3">
              <span className="fw-800">Unlisted:</span>
              <span className="ms-2">
                Mark vehicle as unlisted if this vehicle is out of commission or
                requires service
              </span>
            </div>
          </div>
        ...
        <div className={`d-flex flex-column align-items-center`}>
          ...
          >
            <div className={`d-flex flex-column`}>
              ...
              <span className={`color-gray-700`}>
                View vehicle information and see delivery history
              </span>
            </div>
            <span
              className={`align-self-start link hover`}
          ...
          <div
            className={`${styles.AddVehicleinfoBG} p-3 mt-5 d-flex w-100 align-items-center`}
          >
            <input type="checkbox" />
            <div className="ms-3">
              <span className="fw-800">Unlisted:</span>
      ...
      {type === ModalType.SETTINGSCHANGENAME && (
        ...
        >
          ...
          <span className={`align-self-start mt-1 color-gray-500`}>
            Enter your full name
          </span>

          <div className={`w-100 mt-3 d-flex flex-column`}>
            <ControlInput
              error={!!errorsChangeNameForm.fullname}
              errorMessage={
                errorsChangeNameForm.fullname
                  ? errorsChangeNameForm.fullname.message
                  : ''
              }
              registerValidation={registerChangeNameForm('fullname', {
          ...
          <div className={`mt-5 w-100 d-flex justify-content-between`}>
            ...
            <div className={`w-30 d-flex justify-content-between`}>
              <Button
                click={handleSubmitChangeNameForm(onSubmitChangeNameForm)}
                wide={true}
                label="Update"
                type={ButtonType.PRIMARY}
              />
      ...
      {type === ModalType.SETTINGSCHANGEEMAIL && (
        <div
          className={`d-flex flex-column align-items-center px-3 ${styles.overflow}`}
        >
          <span className={`align-self-start fw-700 text-13`}>
            Change Email{' '}
            {/* <span className={`error ms-2`}>(Currently unavailable)</span> */}
          </span>
          <span className={`align-self-start mt-1 color-gray-500`}>
            Only use a work/company email. Upon approval, your email will be
            updated.
            {/* Only use a work/company email, you’ll receive a validation mail to
            your new email address. Click the "Confirm email" button to complete
            the change. */}
          </span>

          <div className={`w-100 mt-3 d-flex flex-column`}>
            <ControlInput
              error={!!errorsChangeEmailForm.email}
              errorMessage={
                errorsChangeEmailForm.email
                  ? errorsChangeEmailForm.email.message
                  : ''
              }
              registerValidation={registerChangeEmailForm('email', {
            ...
            />
            <ControlInput
              error={!!errorsChangeEmailForm.password}
              errorMessage={
                errorsChangeEmailForm.password
                  ? errorsChangeEmailForm.password.message
                  : ''
              }
              registerValidation={registerChangeEmailForm('password', {
              ...
              type="password"
              placeholder="Enter your Storedash password"
              wide={true}
            />
          ...
          <div className={`mt-5 w-100 d-flex justify-content-between`}>
            ...
            <div className={`w-30 d-flex justify-content-between`}>
              <Button
                click={handleSubmitChangeEmailForm(onSubmitChangeEmailForm)}
                wide={true}
                label="Update"
                type={ButtonType.PRIMARY}
              />
      ...
      {type === ModalType.SETTINGSCHANGEPASSWORD && (
        ...
        >
          ...
          <span className={`align-self-start mt-1 color-gray-500`}>
            Choose a strong password with a minimum of 6 characters, passwords
            are case sensitive
          </span>

          <div className={`w-100 mt-3 d-flex flex-column`}>
            <ControlInput
              error={!!errorsChangePasswordForm.currentPassword}
              errorMessage={
                errorsChangePasswordForm.currentPassword
                  ? errorsChangePasswordForm.currentPassword.message
                  : ''
              }
              registerValidation={registerChangePasswordForm(
                'currentPassword',
                {
                  required: 'Provide Current Password',
                  minLength: {
            ...
            />
            <ControlInput
              error={!!errorsChangePasswordForm.newPassword}
              errorMessage={
                errorsChangePasswordForm.newPassword
                  ? errorsChangePasswordForm.newPassword.message
                  : ''
              }
              registerValidation={registerChangePasswordForm('newPassword', {
            ...
            />
            <ControlInput
              error={!!errorsChangePasswordForm.confirmNewPassword}
              errorMessage={
                errorsChangePasswordForm.confirmNewPassword
                  ? errorsChangePasswordForm.confirmNewPassword.message
                  : ''
              }
              registerValidation={registerChangePasswordForm(
                'confirmNewPassword',
          ...
          <div className={`mt-5 w-100 d-flex justify-content-between`}>
            ...
            <div className={`w-30 d-flex justify-content-between`}>
              <Button
                click={handleSubmitChangePasswordForm(
      ...
      {type === ModalType.SETTINGSCHANGE2FA && (
        ...
        >
          ...
          <span className={`align-self-start mt-1 color-gray-500`}>
            Two-factor authentication (2FA) ensures an additional layer of
            security by requiring a 4-digit PIN to authorize logins. Follow the
          ...
          <div className={`w-100 mt-3 d-flex flex-column`}>
            {/* <Alert
              title=""
              label="SMS charges may apply depending on your network carrier "
      ...
      {type === ModalType.ADDSTAFFMEMBER && (
        ...
        >
          ...
          <span className={`align-self-start mt-1 color-gray-500`}>
            You can update your staff information{' '}
          </span>
          ...
          <div className={`w-100 mt-3 d-flex flex-column`}>
            <div className={`w-20 mt-3 d-flex flex-column align-items-center`}>
              ...
              <span
                className={`color-safety-blue mt-2 fw-500 text-09 hover link`}
              >
                Add photo
              </span>
            </div>
            ...
            <div className={`d-flex flex-column mt-5`}>
              ...
              <div className={`w-100 d-flex align-items-center`}>
                <ControlInput
                  type="text"
                  placeholder="staffname@ company.com"
                  wide={true}
                />
              </div>
            </div>
            ...
            <div className={`d-flex flex-column mt-5`}>
              ...
              <div className={`w-100 d-flex align-items-center`}>
                <ControlInput
                  type="text"
                  placeholder="Enter staff's identity number"
                  wide={true}
                />
              </div>
            </div>
